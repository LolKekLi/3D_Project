								...
								while ((line = stringReader.ReadLine()) != null)
								{
									...
									if (line.StartsWith("//# "))
									{
										...
										if (trimmedLine.StartsWith("//# BLOCK:"))
										{
											...
											{
												throw new Exception("Line '//# BLOCK:' requires a name, please see the documentation");
											}
										...
										else if (trimmedLine.StartsWith("//# REPLACE:"))
										{
											...
											if (string.IsNullOrEmpty(blockName))
											{
												throw new Exception("Line '//# REPLACE:' requires a name, please see the documentation");
											}
										...
										else if (trimmedLineLower.StartsWith("//# float") || (trimmedLineLower.StartsWith("//# fragment") || trimmedLineLower.StartsWith("//# vertex")))
										{
											...
											{
												throw new Exception("//# REPLACE block variables must declare their shader program first ('vertex' or 'fragment')");
											}
											
											if (!currentBlock.isReplaceBlock && !trimmedLineLower.StartsWith("//# float"))
											{
												throw new Exception("Regular block variables must not declare the shader program");
											}
