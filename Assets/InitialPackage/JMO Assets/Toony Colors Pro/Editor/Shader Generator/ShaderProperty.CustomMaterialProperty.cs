		...
		public partial class ShaderProperty
		{
			...
			public class CustomMaterialProperty : IMaterialPropertyName
			{
				...
				public CustomMaterialProperty(ShaderProperty sp, Type implementationType)
				{
					...
					var menuLabel = implementationType.GetProperty("MenuLabel", BindingFlags.Static | BindingFlags.Public);
				...
				{
					return string.Format("half{0} {1};", VariableTypeToChannelsCount(variableType), this.PrintVariableFragment());
				}
