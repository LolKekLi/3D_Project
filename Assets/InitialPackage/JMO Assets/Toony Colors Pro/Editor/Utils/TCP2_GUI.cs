	...
	namespace Utilities
	{
		public static class TCP2_GUI
		{
			...
			private static GUIStyle HeaderLabel
			{
				get
				{
					return SGUILayout.Styles.OrangeBoldLabel;
				}
			}
			...
			private static GUIStyle BigHeaderLabel
			{
				get
				{
					if (_BigHeaderLabel == null)
					{
						...
						_BigHeaderLabel.normal.textColor = SGUILayout.Styles.OrangeColor;
					}
		...
		public class TCP2HeaderHelpDecorator : MaterialPropertyDrawer
		{
			...
			{
				TCP2_GUI.HeaderAndHelp(position, header, null, help, SGUILayout.Styles.OrangeBoldLabel);
			}
